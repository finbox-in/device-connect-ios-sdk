...
class PayloadHelper {
    ...
    internal let encryptKey = SymmetricKey(data: "Zrq9i1grEOJwwgqtjGI7euMKOnhlDhac".data(using: .utf8)!)
    internal let decryptKey = SymmetricKey(data: "2Jd0QSJ3RZLEgo8nlyWqQMPQ58mIKwu0".data(using: .utf8)!)

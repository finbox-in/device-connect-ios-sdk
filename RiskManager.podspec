#
#  Be sure to run `pod spec lint RiskManager.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/finbox-in/device-connect-ios-sdk/"
  ...
  spec.source       = { :git => "https://github.com/finbox-in/device-connect-ios-sdk.git", :tag => "#{spec.version}" }
